...
<head>
  ...
  <meta name="keywords" content="">
	<meta name="description" content="Statistiques de la journée - Sous-réseau">
...
<div class="container">
    ...
    <div class="colonne_1">
			<h4><?php echo _("Statistiques de la journée"); ?> &bull; <span style="color:yellow;"> <?php echo _("sous-réseau"); ?> <?php echo $subnet; ?></span></h4>

			<div id='tableau'>
			<?php
				echo getTable("Subnet-1-".$subnet.".html");
			?>
			</div>
