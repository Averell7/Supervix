...
<head>
  ...
  <title>Idefix : <?php echo _("Service Squid"); ?></title>
  <meta name="author" lang="fr" content="O. Cart.">
  <meta name="keywords" content="">
	<meta name="description" content="Service Squid">
...
<div class="container">
	 ...
	 <div class="header0"></div>
		...
		<div class="header">
			<p>
        <span class="titre"><?php echo _("Service Squid"); ?></span><br />
			</p>
		</div>
    ...
    <div class="colonne_1">
          ...
          <div>
              <?php
 								$commande = 'sudo service squid status';
