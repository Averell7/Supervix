...
<head>
  ...
  <meta name="keywords" content="">
	<meta name="description" content="Statistiques bandwidthd sur un an - Top 20">
...
<div class="container">
    ...
    <div class="colonne_1">
			<h4><?php echo _("Statistiques de l'année"); ?> &bull; <span style="color:yellow;">Top 20</span></h4>

			<div id='tableau'>
			<?php
				echo getTable("index4.html");
			?>
			</div>
