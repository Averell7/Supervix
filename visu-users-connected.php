...
<head>
  ...
  <title>Idefix : <?php echo _("Utilisateurs connectés"); ?></title>
  <meta name="author" lang="fr" content="O. Cart.">
  <meta name="keywords" content="">
	<meta name="description" content="Utilisateurs connectés">
...
<div class="container">
	 ...
	 <div class="header0"></div>
		...
		<div class="header">
			<p>
        <span class="titre"><?php echo _("Utilisateurs connectés"); ?></span><br />
			</p>
		</div>
    ...
    <div class="colonne_1">
          ...
          <div>
              <?php
 								$commande = 'sudo /usr/lib/idefix/dhcp-parse.py 2>&1';
