...
<head>
  ...
  <meta name="keywords" content="">
	<meta name="description" content="Statistiques du mois - Top 20">
...
<div class="container">
    ...
    <div class="colonne_1">
			<h4><?php echo _("Statistiques du mois"); ?> &bull; <span style="color:yellow;">Top 20</span></h4>

			<div id='tableau'>
			<?php
				echo getTable("index3.html");
			?>
			</div>
