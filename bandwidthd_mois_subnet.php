...
<head>
  ...
  <meta name="keywords" content="">
	<meta name="description" content="Statistiques du mois - Sous-réseau">
...
<div class="container">
    ...
    <div class="colonne_1">
			<h4><?php echo _("Statistiques du mois"); ?> &bull; <span style="color:yellow;"> <?php echo _("sous-réseau"); ?> <?php echo $subnet; ?></span></h4>

			<div id='tableau'>
			<?php
				echo getTable("Subnet-3-".$subnet.".html");
			?>
			</div>
