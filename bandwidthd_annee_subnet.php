...
<head>
  ...
  <meta name="keywords" content="">
	<meta name="description" content="Statistiques bandwidthd sur un an - Sous-réseau">
...
<div class="container">
    ...
    <div class="colonne_1">
			<h4><?php echo _("Statistiques de l'année"); ?> &bull; <span style="color:yellow;"> <?php echo _("sous-réseau"); ?> <?php echo $subnet; ?></span></h4>

			<div id='tableau'>
			<?php
				echo getTable("Subnet-4-".$subnet.".html");
			?>
			</div>
