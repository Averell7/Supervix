...
<head>
  ...
  <script src="$/js/jquery-3.3.1.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="$/css/screen1.css" media="screen" />
</head>
...
<div class="container">
	 ...
	 <div class="header0"><?php include_once "$/includes/i18n.php"; ?></div>
		...
		<div class="header">
			<p>
				<span class="titre"><?php echo _("Bienvenue sur Idéfix !"); ?></span>
			</p>
		</div>
    ...
    <div class="colonne_1">
			...
			<div id="cf">
				<img class="bottom" src="$/icones/idefix.png" />
				<img class="top" src="$/icones/rock64.png" />
			</div>
