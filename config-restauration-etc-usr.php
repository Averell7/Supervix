...
<head>
  ...
  <title><?php echo _("Restauration de configuration système"); ?></title>
...
<div class="container">
	 ...
	 <div class="header0"></div>
		...
		<div class="header">
			<p>
				<span class="titre"><?php echo _("Restauration de configuration système"); ?></span>
			</p>
		</div>
		...
		<?php
				...
				$nbBackupDesires	= NB_BACKUP_DESIRES;		// Nb de backups souhaités à analyser
