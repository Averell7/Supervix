...
if(PHP_OS == 'Linux') {
	...
	$retour = "0.00 0.07 0.10 1/167 26204";
}
$data = explode ( " " , $retour );
...
if( isset($z["Testing DNS filtering"]["Status"]) ) {
	...
	$out["Testing DNS filtering"]["Web site"]["jeux.fr"]["locked"] = $z["Testing DNS filtering"]["Web site"]["jeux.fr"]["locked"];
	$out["Testing DNS filtering"]["Web site"]["jeux.fr"]["Status"] = $z["Testing DNS filtering"]["Web site"]["jeux.fr"]["Status"];
}
