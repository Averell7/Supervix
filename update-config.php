...
<head>
  ...
  <title>Idefix : <?php echo _("Mise à jour immédiate du filtre"); ?></title>
...
<div class="container">
	 ...
	 <div class="header0"></div>
		...
		<div class="header">
			<p>
        <span class="titre"><?php echo _("Mise à jour immédiate du filtre"); ?></span><br />
			</p>
		</div>
    ...
    <div class="colonne_1">
          ...
          <div>
              <?php
								$commande = 'sudo /usr/lib/idefix/idefix.py -f 2>&1';
 								//echo "<p>"._("Cette commande va être exécutée")." :<br />";
                //echo "<b>shell_exec('".$commande."')</b></p>";
								$cmd = str_replace(' ', '_', $commande);
								
								echo "<button type='button' id='update_config' cmd=\"".$cmd."\">";
								echo "<img src='$/icones/cog_edit.png' alt='' /> "._("Mettre à jour le filtre");
								echo "</button>";
              ?>
					<div id="result"></div> 
          </div>
